...
def mock_layout_element():
    return LayoutElement(100, 100, 300, 300, None, text="Sample text", type="Text")
...
def mock_ocr_regions():
    return [
        EmbeddedTextRegion(10, 10, 90, 90, None, "0"),
        EmbeddedTextRegion(200, 200, 300, 300, None, "1"),
        EmbeddedTextRegion(500, 320, 600, 350, None, "3"),
    ]
